...
function initializeServiceWorker() {
  ...
  //            log that it was successful.
        console.log('The service worker has been successfully registered:', registration);
        
  // B5. TODO - In the event that the service worker registration fails, console
  //            log that it has failed.
      },
        (error) => { console.error(`The service worker registration failed: ${error}`); })
    })
  }
  else {
    console.error('The service worker registration not recognized.');
  }
